...
<link rel="stylesheet" href="<?php echo $location; ?>includes/themes/halu/style.css" type="text/css" />
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $location; ?>includes/themes/halu/images/favicon.png" />
<?php echo $pg['head']; ?>
</head>
...
<a href="<?php echo $location; ?>./"><img src="<?php echo $location; ?>includes/themes/halu/images/logo.png" border="0" alt="" /></a>
</div>
